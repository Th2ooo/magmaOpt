...
def setAtt(file="none",attname="none",attval="none"):
    """
    Set the field attname in file, formatted in exch.data style
    ...
    attname : str, optional
        name of the attribute. The default is "none".
    attval : any type, optional
        value of the attribute. The default is "none".
    """
    # Open file
    ff = open(file,"r")
    content = ff.read()
...
def getrAtt(file="none",attname="none",npar=1) :
    """
    Get real value associated to keyword in file formatted in exch.data way
    
    Parameters
    ----------
    file : TYPE, optional
        file to retrive the value. The default is "none".
    attname : str, optional
        keyword to get. The default is "none".
    npar : int, optional
        number of real parameters to obtain. The default is 1.
...
def printHisto(*args):
    """
    Fill history file file with any value provided in *args

    Parameters
    ----------
    *args : TYPE
        here,
        it (int) number of the iteration
...
def recomp_histo() :
    """
    Function to recompute the histo.data file after execution of the code
    """
